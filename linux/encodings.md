## base64 encoding
* Base64 is a binary-to-text encoding that uses 64 printable characters to represent >
* `base64 filename` -
...
## rot13 cypher
* ROT13 is a simple letter substitution cipher that replaces a letter with the 13th l>
* using rot13 again on the cypher decodes it since 13x2=26.
* `echo 'text' | tr 'A-Za-z' 'N-ZA-Mn-za-m'` -
it uses tr command to implement rot13 cypher on text
* `tr` -
it means translate, it replaces every occurence of a character from the first set wit>
